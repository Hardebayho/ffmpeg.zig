...
pub extern fn av_get_sample_fmt_name(sample_fmt: enum_AVSampleFormat) ?[*:0]const u8;
pub extern fn av_get_sample_fmt(name: ?[*:0]const u8) enum_AVSampleFormat;
...
pub extern fn av_get_sample_fmt_string(buf: ?[*]u8, buf_size: c_int, sample_fmt: enum_AVSampleFormat) ?[*:0]u8;
...
pub extern fn av_samples_fill_arrays(audio_data: ?[*c]?[*]u8, linesize: [*c]c_int, buf: ?[*:0]const u8, nb_channels: c_int, nb_samples: c_int, sample_fmt: enum_AVSampleFormat, @"align": c_int) c_int;
pub extern fn av_samples_alloc(audio_data: ?[*c]?[*]u8, linesize: [*c]c_int, nb_channels: c_int, nb_samples: c_int, sample_fmt: enum_AVSampleFormat, @"align": c_int) c_int;
pub extern fn av_samples_alloc_array_and_samples(audio_data: ?[*c][*c]?[*]u8, linesize: [*c]c_int, nb_channels: c_int, nb_samples: c_int, sample_fmt: enum_AVSampleFormat, @"align": c_int) c_int;
pub extern fn av_samples_copy(dst: [*c]?[*]u8, src: [*c]const ?[*]u8, dst_offset: c_int, src_offset: c_int, nb_samples: c_int, nb_channels: c_int, sample_fmt: enum_AVSampleFormat) c_int;
pub extern fn av_samples_set_silence(audio_data: [*c]?[*]u8, offset: c_int, nb_samples: c_int, nb_channels: c_int, sample_fmt: enum_AVSampleFormat) c_int;
pub extern fn avutil_version() c_uint;
pub extern fn av_version_info() ?[*:0]const u8;
pub extern fn avutil_configuration() ?[*:0]const u8;
pub extern fn avutil_license() ?[*:0]const u8;
...
pub extern fn av_get_media_type_string(media_type: enum_AVMediaType) ?[*:0]const u8;
...
pub extern fn strtoimax(noalias __nptr: ?[*:0]const u8, noalias __endptr: [*c]?[*]u8, __base: c_int) intmax_t;
pub extern fn strtoumax(noalias __nptr: ?[*:0]const u8, noalias __endptr: [*c]?[*]u8, __base: c_int) uintmax_t;
...
pub extern fn nan(__tagb: ?[*:0]const u8) f64;
pub extern fn __nan(__tagb: ?[*:0]const u8) f64;
...
pub extern fn nanf(__tagb: ?[*:0]const u8) f32;
pub extern fn __nanf(__tagb: ?[*:0]const u8) f32;
...
pub extern fn nanl(__tagb: ?[*:0]const u8) c_longdouble;
pub extern fn __nanl(__tagb: ?[*:0]const u8) c_longdouble;
...
pub extern fn tempnam(__dir: ?[*:0]const u8, __pfx: ?[*:0]const u8) ?[*]u8;
pub extern fn fflush(__stream: [*c]FILE) c_int;
pub extern fn fflush_unlocked(__stream: [*c]FILE) c_int;
pub extern fn fopen(__filename: ?[*:0]const u8, __modes: ?[*:0]const u8) [*c]FILE;
pub extern fn freopen(noalias __filename: ?[*:0]const u8, noalias __modes: ?[*:0]const u8, noalias __stream: [*c]FILE) [*c]FILE;
...
pub extern fn open_memstream(__bufloc: [*c]?[*]u8, __sizeloc: [*c]usize) [*c]FILE;
pub extern fn setbuf(noalias __stream: [*c]FILE, noalias __buf: ?[*]u8) void;
pub extern fn setvbuf(noalias __stream: [*c]FILE, noalias __buf: ?[*]u8, __modes: c_int, __n: usize) c_int;
pub extern fn setbuffer(noalias __stream: [*c]FILE, noalias __buf: ?[*]u8, __size: usize) void;
pub extern fn setlinebuf(__stream: [*c]FILE) void;
pub extern fn fprintf(__stream: [*c]FILE, __format: ?[*:0]const u8, ...) c_int;
pub extern fn printf(__format: ?[*:0]const u8, ...) c_int;
pub extern fn sprintf(__s: ?[*]u8, __format: ?[*:0]const u8, ...) c_int;
pub extern fn vfprintf(__s: [*c]FILE, __format: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
pub fn vprintf(arg___fmt: ?[*:0]const u8, arg___arg: [*c]struct___va_list_tag) callconv(.C) c_int {
    var __fmt = arg___fmt;
    var __arg = arg___arg;
    return vfprintf(stdout, __fmt, __arg);
}
pub extern fn vsprintf(__s: ?[*]u8, __format: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
pub extern fn snprintf(__s: ?[*]u8, __maxlen: c_ulong, __format: ?[*:0]const u8, ...) c_int;
pub extern fn vsnprintf(__s: ?[*]u8, __maxlen: c_ulong, __format: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
pub extern fn vdprintf(__fd: c_int, noalias __fmt: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
pub extern fn dprintf(__fd: c_int, noalias __fmt: ?[*:0]const u8, ...) c_int;
pub extern fn fscanf(noalias __stream: [*c]FILE, noalias __format: ?[*:0]const u8, ...) c_int;
...
pub extern fn vfscanf(noalias __s: [*c]FILE, noalias __format: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
pub extern fn vscanf(noalias __format: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
pub extern fn vsscanf(noalias __s: ?[*:0]const u8, noalias __format: ?[*:0]const u8, __arg: [*c]struct___va_list_tag) c_int;
...
pub fn getc_unlocked(arg___fp: [*c]FILE) callconv(.C) c_int {
    var __fp = arg___fp;
    return if (__builtin_expect(@bitCast(c_long, @as(c_long, @boolToInt(__fp.*._IO_read_ptr >= __fp.*._IO_read_end))), @bitCast(c_long, @as(c_long, @as(c_int, 0)))) != 0) __uflow(__fp) else @bitCast(c_int, @as(c_uint, @ptrCast(?[*]u8, @alignCast(@import("std").meta.alignment(u8), blk: {
...
pub fn getchar_unlocked() callconv(.C) c_int {
    return if (__builtin_expect(@bitCast(c_long, @as(c_long, @boolToInt(stdin.*._IO_read_ptr >= stdin.*._IO_read_end))), @bitCast(c_long, @as(c_long, @as(c_int, 0)))) != 0) __uflow(stdin) else @bitCast(c_int, @as(c_uint, @ptrCast(?[*]u8, @alignCast(@import("std").meta.alignment(u8), blk: {
...
pub extern fn fgets(noalias __s: ?[*]u8, __n: c_int, noalias __stream: [*c]FILE) ?[*]u8;
pub extern fn __getdelim(noalias __lineptr: [*c]?[*]u8, noalias __n: [*c]usize, __delimiter: c_int, noalias __stream: [*c]FILE) __ssize_t;
pub extern fn getdelim(noalias __lineptr: [*c]?[*]u8, noalias __n: [*c]usize, __delimiter: c_int, noalias __stream: [*c]FILE) __ssize_t;
pub extern fn getline(noalias __lineptr: [*c]?[*]u8, noalias __n: [*c]usize, noalias __stream: [*c]FILE) __ssize_t;
pub extern fn fputs(noalias __s: ?[*:0]const u8, noalias __stream: [*c]FILE) c_int;
...
pub fn atof(arg___nptr: ?[*:0]const u8) callconv(.C) f64 {
    var __nptr = arg___nptr;
    return strtod(__nptr, @ptrCast([*c]?[*]u8, @alignCast(@import("std").meta.alignment(?[*]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))));
}
pub fn atoi(arg___nptr: ?[*:0]const u8) callconv(.C) c_int {
    var __nptr = arg___nptr;
    return @bitCast(c_int, @truncate(c_int, strtol(__nptr, @ptrCast([*c]?[*]u8, @alignCast(@import("std").meta.alignment(?[*]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))), @as(c_int, 10))));
}
pub fn atol(arg___nptr: ?[*:0]const u8) callconv(.C) c_long {
    var __nptr = arg___nptr;
    return strtol(__nptr, @ptrCast([*c]?[*]u8, @alignCast(@import("std").meta.alignment(?[*]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))), @as(c_int, 10));
}
pub fn atoll(arg___nptr: ?[*:0]const u8) callconv(.C) c_longlong {
    var __nptr = arg___nptr;
    return strtoll(__nptr, @ptrCast([*c]?[*]u8, @alignCast(@import("std").meta.alignment(?[*]u8), @intToPtr(?*anyopaque, @as(c_int, 0)))), @as(c_int, 10));
}
pub extern fn strtod(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8) f64;
pub extern fn strtof(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8) f32;
pub extern fn strtold(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8) c_longdouble;
pub extern fn strtol(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8, __base: c_int) c_long;
pub extern fn strtoul(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8, __base: c_int) c_ulong;
pub extern fn strtoq(noalias __nptr: ?[*:0]const u8, noalias __endptr: [*c]?[*]u8, __base: c_int) c_longlong;
pub extern fn strtouq(noalias __nptr: ?[*:0]const u8, noalias __endptr: [*c]?[*]u8, __base: c_int) c_ulonglong;
pub extern fn strtoll(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8, __base: c_int) c_longlong;
pub extern fn strtoull(__nptr: ?[*:0]const u8, __endptr: [*c]?[*]u8, __base: c_int) c_ulonglong;
pub extern fn l64a(__n: c_long) ?[*]u8;
pub extern fn a64l(__s: ?[*:0]const u8) c_long;
...
pub extern fn initstate_r(__seed: c_uint, noalias __statebuf: ?[*]u8, __statelen: usize, noalias __buf: [*c]struct_random_data) c_int;
pub extern fn setstate_r(noalias __statebuf: ?[*]u8, noalias __buf: [*c]struct_random_data) c_int;
...
pub extern fn getenv(__name: ?[*:0]const u8) ?[*]u8;
pub extern fn putenv(__string: ?[*]u8) c_int;
pub extern fn setenv(__name: ?[*:0]const u8, __value: ?[*:0]const u8, __replace: c_int) c_int;
pub extern fn unsetenv(__name: ?[*:0]const u8) c_int;
...
pub extern fn system(__command: ?[*:0]const u8) c_int;
pub extern fn realpath(noalias __name: ?[*:0]const u8, noalias __resolved: ?[*]u8) ?[*]u8;
...
pub fn bsearch(arg___key: ?*const anyopaque, arg___base: ?*const anyopaque, arg___nmemb: usize, arg___size: usize, arg___compar: __compar_fn_t) callconv(.C) ?*anyopaque {
    ...
    while (__l < __u) {
        ...
        __p = @intToPtr(?*anyopaque, @ptrToInt(@ptrCast(?[*:0]const u8, @alignCast(@import("std").meta.alignment(u8), __base)) + (__idx *% __size)));
...
pub extern fn ecvt(__value: f64, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int) ?[*]u8;
pub extern fn fcvt(__value: f64, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int) ?[*]u8;
pub extern fn gcvt(__value: f64, __ndigit: c_int, __buf: ?[*]u8) ?[*]u8;
pub extern fn qecvt(__value: c_longdouble, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int) ?[*]u8;
pub extern fn qfcvt(__value: c_longdouble, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int) ?[*]u8;
pub extern fn qgcvt(__value: c_longdouble, __ndigit: c_int, __buf: ?[*]u8) ?[*]u8;
pub extern fn ecvt_r(__value: f64, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int, noalias __buf: ?[*]u8, __len: usize) c_int;
pub extern fn fcvt_r(__value: f64, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int, noalias __buf: ?[*]u8, __len: usize) c_int;
pub extern fn qecvt_r(__value: c_longdouble, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int, noalias __buf: ?[*]u8, __len: usize) c_int;
pub extern fn qfcvt_r(__value: c_longdouble, __ndigit: c_int, noalias __decpt: [*c]c_int, noalias __sign: [*c]c_int, noalias __buf: ?[*]u8, __len: usize) c_int;
pub extern fn mblen(__s: ?[*:0]const u8, __n: usize) c_int;
pub extern fn mbtowc(noalias __pwc: [*c]wchar_t, noalias __s: ?[*:0]const u8, __n: usize) c_int;
pub extern fn wctomb(__s: ?[*]u8, __wchar: wchar_t) c_int;
pub extern fn mbstowcs(noalias __pwcs: [*c]wchar_t, noalias __s: ?[*:0]const u8, __n: usize) usize;
pub extern fn wcstombs(noalias __s: ?[*]u8, noalias __pwcs: [*c]const wchar_t, __n: usize) usize;
pub extern fn rpmatch(__response: ?[*:0]const u8) c_int;
pub extern fn getsubopt(noalias __optionp: [*c]?[*]u8, noalias __tokens: [*c]const ?[*]u8, noalias __valuep: [*c]?[*]u8) c_int;
...
pub extern fn strcpy(__dest: ?[*]u8, __src: ?[*:0]const u8) ?[*]u8;
pub extern fn strncpy(__dest: ?[*]u8, __src: ?[*:0]const u8, __n: c_ulong) ?[*]u8;
pub extern fn strcat(__dest: ?[*]u8, __src: ?[*:0]const u8) ?[*]u8;
pub extern fn strncat(__dest: ?[*]u8, __src: ?[*:0]const u8, __n: c_ulong) ?[*]u8;
pub extern fn strcmp(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8) c_int;
pub extern fn strncmp(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8, __n: c_ulong) c_int;
pub extern fn strcoll(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8) c_int;
pub extern fn strxfrm(__dest: ?[*]u8, __src: ?[*:0]const u8, __n: c_ulong) c_ulong;
...
pub const struct___locale_struct = extern struct {
    ...
    __names: [13]?[*:0]const u8,
};
pub const __locale_t = [*c]struct___locale_struct;
pub const locale_t = __locale_t;
pub extern fn strcoll_l(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8, __l: locale_t) c_int;
pub extern fn strxfrm_l(__dest: ?[*]u8, __src: ?[*:0]const u8, __n: usize, __l: locale_t) usize;
pub extern fn strdup(__s: ?[*:0]const u8) ?[*]u8;
pub extern fn strndup(__string: ?[*:0]const u8, __n: c_ulong) ?[*]u8;
pub extern fn strchr(__s: ?[*:0]const u8, __c: c_int) ?[*]u8;
pub extern fn strrchr(__s: ?[*:0]const u8, __c: c_int) ?[*]u8;
pub extern fn strcspn(__s: ?[*:0]const u8, __reject: ?[*:0]const u8) c_ulong;
pub extern fn strspn(__s: ?[*:0]const u8, __accept: ?[*:0]const u8) c_ulong;
pub extern fn strpbrk(__s: ?[*:0]const u8, __accept: ?[*:0]const u8) ?[*]u8;
pub extern fn strstr(__haystack: ?[*:0]const u8, __needle: ?[*:0]const u8) ?[*]u8;
pub extern fn strtok(__s: ?[*]u8, __delim: ?[*:0]const u8) ?[*]u8;
pub extern fn __strtok_r(noalias __s: ?[*]u8, noalias __delim: ?[*:0]const u8, noalias __save_ptr: [*c]?[*]u8) ?[*]u8;
pub extern fn strtok_r(noalias __s: ?[*]u8, noalias __delim: ?[*:0]const u8, noalias __save_ptr: [*c]?[*]u8) ?[*]u8;
pub extern fn strlen(__s: ?[*:0]const u8) c_ulong;
pub extern fn strnlen(__string: ?[*:0]const u8, __maxlen: usize) usize;
...
pub extern fn index(__s: ?[*:0]const u8, __c: c_int) ?[*]u8;
pub extern fn rindex(__s: ?[*:0]const u8, __c: c_int) ?[*]u8;
pub extern fn ffs(__i: c_int) c_int;
pub extern fn ffsl(__l: c_long) c_int;
pub extern fn ffsll(__ll: c_longlong) c_int;
pub extern fn strcasecmp(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8) c_int;
pub extern fn strncasecmp(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8, __n: c_ulong) c_int;
pub extern fn strcasecmp_l(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8, __loc: locale_t) c_int;
pub extern fn strncasecmp_l(__s1: ?[*:0]const u8, __s2: ?[*:0]const u8, __n: usize, __loc: locale_t) c_int;
pub extern fn explicit_bzero(__s: ?*anyopaque, __n: usize) void;
pub extern fn strsep(noalias __stringp: [*c]?[*]u8, noalias __delim: ?[*:0]const u8) ?[*]u8;
pub extern fn strsignal(__sig: c_int) ?[*]u8;
pub extern fn __stpcpy(noalias __dest: ?[*]u8, noalias __src: ?[*:0]const u8) ?[*]u8;
pub extern fn stpcpy(__dest: ?[*]u8, __src: ?[*:0]const u8) ?[*]u8;
pub extern fn __stpncpy(noalias __dest: ?[*]u8, noalias __src: ?[*:0]const u8, __n: usize) ?[*]u8;
pub extern fn stpncpy(__dest: ?[*]u8, __src: ?[*:0]const u8, __n: c_ulong) ?[*]u8;
...
} // include/libavutil/common.h:350:13: warning: TODO implement function '__builtin_add_overflow' in std.zig.c_builtins
// include/libavutil/common.h:347:33: warning: unable to translate function, demoted to extern
pub extern fn av_sat_add64_c(arg_a: i64, arg_b: i64) i64; // include/libavutil/common.h:369:13: warning: TODO implement function '__builtin_sub_overflow' in std.zig.c_builtins
// include/libavutil/common.h:366:33: warning: unable to translate function, demoted to extern
...
pub extern fn av_strdup(s: ?[*:0]const u8) ?[*]u8;
pub extern fn av_strndup(s: ?[*:0]const u8, len: usize) ?[*]u8;
pub extern fn av_memdup(p: ?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn av_memcpy_backptr(dst: ?[*]u8, back: c_int, cnt: c_int) void;
...
pub extern fn av_dynarray2_add(tab_ptr: [*c]?*anyopaque, nb_ptr: [*c]c_int, elem_size: usize, elem_data: ?[*:0]const u8) ?*anyopaque;
...
pub extern fn av_strerror(errnum: c_int, errbuf: ?[*]u8, errbuf_size: usize) c_int;
pub fn av_make_error_string(arg_errbuf: ?[*]u8, arg_errbuf_size: usize, arg_errnum: c_int) callconv(.C) ?[*]u8 {
...
pub const struct_AVClass = extern struct {
    ...
    item_name: ?fn (?*anyopaque) callconv(.C) ?[*:0]const u8,
    ...
    query_ranges: ?fn ([*c]?*struct_AVOptionRanges, ?*anyopaque, ?[*:0]const u8, c_int) callconv(.C) c_int,
...
pub extern fn av_log(avcl: ?*anyopaque, level: c_int, fmt: ?[*:0]const u8, ...) void;
pub extern fn av_log_once(avcl: ?*anyopaque, initial_level: c_int, subsequent_level: c_int, state: [*c]c_int, fmt: ?[*:0]const u8, ...) void;
pub extern fn av_vlog(avcl: ?*anyopaque, level: c_int, fmt: ?[*:0]const u8, vl: [*c]struct___va_list_tag) void;
pub extern fn av_log_get_level() c_int;
pub extern fn av_log_set_level(level: c_int) void;
pub extern fn av_log_set_callback(callback: ?fn (?*anyopaque, c_int, ?[*:0]const u8, [*c]struct___va_list_tag) callconv(.C) void) void;
pub extern fn av_log_default_callback(avcl: ?*anyopaque, level: c_int, fmt: ?[*:0]const u8, vl: [*c]struct___va_list_tag) void;
pub extern fn av_default_item_name(ctx: ?*anyopaque) ?[*:0]const u8;
pub extern fn av_default_get_category(ptr: ?*anyopaque) AVClassCategory;
pub extern fn av_log_format_line(ptr: ?*anyopaque, level: c_int, fmt: ?[*:0]const u8, vl: [*c]struct___va_list_tag, line: ?[*]u8, line_size: c_int, print_prefix: [*c]c_int) void;
pub extern fn av_log_format_line2(ptr: ?*anyopaque, level: c_int, fmt: ?[*:0]const u8, vl: [*c]struct___va_list_tag, line: ?[*]u8, line_size: c_int, print_prefix: [*c]c_int) c_int;
...
pub extern fn av_fopen_utf8(path: ?[*:0]const u8, mode: ?[*:0]const u8) [*c]FILE;
pub extern fn av_get_time_base_q() AVRational;
pub extern fn av_fourcc_make_string(buf: ?[*]u8, fourcc: u32) ?[*]u8;
...
pub extern fn av_buffer_create(data: ?[*]u8, size: usize, free: ?fn (?*anyopaque, ?[*]u8) callconv(.C) void, @"opaque": ?*anyopaque, flags: c_int) [*c]AVBufferRef;
pub extern fn av_buffer_default_free(@"opaque": ?*anyopaque, data: ?[*]u8) void;
...
pub extern fn av_dict_get(m: ?*const AVDictionary, key: ?[*:0]const u8, prev: [*c]const AVDictionaryEntry, flags: c_int) [*c]AVDictionaryEntry;
pub extern fn av_dict_count(m: ?*const AVDictionary) c_int;
pub extern fn av_dict_set(pm: [*c]?*AVDictionary, key: ?[*:0]const u8, value: ?[*:0]const u8, flags: c_int) c_int;
pub extern fn av_dict_set_int(pm: [*c]?*AVDictionary, key: ?[*:0]const u8, value: i64, flags: c_int) c_int;
pub extern fn av_dict_parse_string(pm: [*c]?*AVDictionary, str: ?[*:0]const u8, key_val_sep: ?[*:0]const u8, pairs_sep: ?[*:0]const u8, flags: c_int) c_int;
...
pub extern fn av_dict_get_string(m: ?*const AVDictionary, buffer: [*c]?[*]u8, key_val_sep: u8, pairs_sep: u8) c_int;
...
pub extern fn av_get_channel_layout(name: ?[*:0]const u8) u64;
pub extern fn av_get_extended_channel_layout(name: ?[*:0]const u8, channel_layout: [*c]u64, nb_channels: [*c]c_int) c_int;
pub extern fn av_get_channel_layout_string(buf: ?[*]u8, buf_size: c_int, nb_channels: c_int, channel_layout: u64) void;
...
pub extern fn av_get_channel_name(channel: u64) ?[*:0]const u8;
pub extern fn av_get_channel_description(channel: u64) ?[*:0]const u8;
pub extern fn av_get_standard_channel_layout(index: c_uint, layout: [*c]u64, name: [*c]?[*:0]const u8) c_int;
pub extern fn av_channel_name(buf: ?[*]u8, buf_size: usize, channel: enum_AVChannel) c_int;
pub extern fn av_channel_name_bprint(bp: ?*struct_AVBPrint, channel_id: enum_AVChannel) void;
pub extern fn av_channel_description(buf: ?[*]u8, buf_size: usize, channel: enum_AVChannel) c_int;
pub extern fn av_channel_description_bprint(bp: ?*struct_AVBPrint, channel_id: enum_AVChannel) void;
pub extern fn av_channel_from_string(name: ?[*:0]const u8) enum_AVChannel;
pub extern fn av_channel_layout_from_mask(channel_layout: [*c]AVChannelLayout, mask: u64) c_int;
pub extern fn av_channel_layout_from_string(channel_layout: [*c]AVChannelLayout, str: ?[*:0]const u8) c_int;
...
pub extern fn av_channel_layout_describe(channel_layout: [*c]const AVChannelLayout, buf: ?[*]u8, buf_size: usize) c_int;
...
pub extern fn av_channel_layout_index_from_string(channel_layout: [*c]const AVChannelLayout, name: ?[*:0]const u8) c_int;
pub extern fn av_channel_layout_channel_from_string(channel_layout: [*c]const AVChannelLayout, name: ?[*:0]const u8) enum_AVChannel;
...
pub extern fn av_get_colorspace_name(val: enum_AVColorSpace) ?[*:0]const u8;
...
pub extern fn av_frame_side_data_name(@"type": enum_AVFrameSideDataType) ?[*:0]const u8;
...
pub extern fn av_hwdevice_find_type_by_name(name: ?[*:0]const u8) enum_AVHWDeviceType;
pub extern fn av_hwdevice_get_type_name(@"type": enum_AVHWDeviceType) ?[*:0]const u8;
...
pub extern fn av_hwdevice_ctx_create(device_ctx: [*c][*c]AVBufferRef, @"type": enum_AVHWDeviceType, device: ?[*:0]const u8, opts: ?*AVDictionary, flags: c_int) c_int;
...
pub extern fn avcodec_get_name(id: enum_AVCodecID) ?[*:0]const u8;
...
pub extern fn avcodec_profile_name(codec_id: enum_AVCodecID, profile: c_int) ?[*:0]const u8;
...
pub extern fn avcodec_find_decoder_by_name(name: ?[*:0]const u8) [*c]const AVCodec;
pub extern fn avcodec_find_encoder(id: enum_AVCodecID) [*c]const AVCodec;
pub extern fn avcodec_find_encoder_by_name(name: ?[*:0]const u8) [*c]const AVCodec;
...
pub extern fn av_get_profile_name(codec: [*c]const AVCodec, profile: c_int) ?[*:0]const u8;
...
pub extern fn avcodec_descriptor_get_by_name(name: ?[*:0]const u8) [*c]const AVCodecDescriptor;
...
pub extern fn av_xiphlacing(s: ?[*]u8, v: c_uint) c_uint;
...
pub extern fn av_packet_from_data(pkt: [*c]AVPacket, data: ?[*]u8, size: c_int) c_int;
pub extern fn av_packet_new_side_data(pkt: [*c]AVPacket, @"type": enum_AVPacketSideDataType, size: usize) ?[*]u8;
pub extern fn av_packet_add_side_data(pkt: [*c]AVPacket, @"type": enum_AVPacketSideDataType, data: ?[*]u8, size: usize) c_int;
pub extern fn av_packet_shrink_side_data(pkt: [*c]AVPacket, @"type": enum_AVPacketSideDataType, size: usize) c_int;
pub extern fn av_packet_get_side_data(pkt: [*c]const AVPacket, @"type": enum_AVPacketSideDataType, size: [*c]usize) ?[*]u8;
pub extern fn av_packet_side_data_name(@"type": enum_AVPacketSideDataType) ?[*:0]const u8;
pub extern fn av_packet_pack_dictionary(dict: ?*AVDictionary, size: [*c]usize) ?[*]u8;
pub extern fn av_packet_unpack_dictionary(data: ?[*:0]const u8, size: usize, dict: [*c]?*AVDictionary) c_int;
...
pub const struct_AVHWAccel = extern struct {
    ...
    start_frame: ?fn ([*c]AVCodecContext, ?[*:0]const u8, u32) callconv(.C) c_int,
    decode_params: ?fn ([*c]AVCodecContext, c_int, ?[*:0]const u8, u32) callconv(.C) c_int,
    decode_slice: ?fn ([*c]AVCodecContext, ?[*:0]const u8, u32) callconv(.C) c_int,
...
pub extern fn avcodec_configuration() ?[*:0]const u8;
pub extern fn avcodec_license() ?[*:0]const u8;
...
pub const struct_AVCodecParser = extern struct {
    ...
    parser_parse: ?fn ([*c]AVCodecParserContext, [*c]AVCodecContext, [*c]?[*:0]const u8, [*c]c_int, ?[*:0]const u8, c_int) callconv(.C) c_int,
    parser_close: ?fn ([*c]AVCodecParserContext) callconv(.C) void,
    split: ?fn ([*c]AVCodecContext, ?[*:0]const u8, c_int) callconv(.C) c_int,
};
...
pub extern fn av_parser_parse2(s: [*c]AVCodecParserContext, avctx: [*c]AVCodecContext, poutbuf: [*c]?[*]u8, poutbuf_size: [*c]c_int, buf: ?[*:0]const u8, buf_size: c_int, pts: i64, dts: i64, pos: i64) c_int;
pub extern fn av_parser_close(s: [*c]AVCodecParserContext) void;
pub extern fn avcodec_encode_subtitle(avctx: [*c]AVCodecContext, buf: ?[*]u8, buf_size: c_int, sub: [*c]const AVSubtitle) c_int;
...
pub extern fn avcodec_string(buf: ?[*]u8, buf_size: c_int, enc: [*c]AVCodecContext, encode: c_int) void;
...
pub extern fn avcodec_fill_audio_frame(frame: [*c]AVFrame, nb_channels: c_int, sample_fmt: enum_AVSampleFormat, buf: ?[*:0]const u8, buf_size: c_int, @"align": c_int) c_int;
...
pub extern fn strftime(noalias __s: ?[*]u8, __maxsize: usize, noalias __format: ?[*:0]const u8, noalias __tp: [*c]const struct_tm) usize;
pub extern fn strftime_l(noalias __s: ?[*]u8, __maxsize: usize, noalias __format: ?[*:0]const u8, noalias __tp: [*c]const struct_tm, __loc: locale_t) usize;
pub extern fn gmtime(__timer: [*c]const time_t) [*c]struct_tm;
pub extern fn localtime(__timer: [*c]const time_t) [*c]struct_tm;
pub extern fn gmtime_r(noalias __timer: [*c]const time_t, noalias __tp: [*c]struct_tm) [*c]struct_tm;
pub extern fn localtime_r(noalias __timer: [*c]const time_t, noalias __tp: [*c]struct_tm) [*c]struct_tm;
pub extern fn asctime(__tp: [*c]const struct_tm) ?[*]u8;
pub extern fn ctime(__timer: [*c]const time_t) ?[*]u8;
pub extern fn asctime_r(noalias __tp: [*c]const struct_tm, noalias __buf: ?[*]u8) ?[*]u8;
pub extern fn ctime_r(noalias __timer: [*c]const time_t, noalias __buf: ?[*]u8) ?[*]u8;
...
pub const struct_AVIOContext = extern struct {
    ...
    buf_end: ?[*]u8,
    @"opaque": ?*anyopaque,
    read_packet: ?fn (?*anyopaque, ?[*]u8, c_int) callconv(.C) c_int,
    write_packet: ?fn (?*anyopaque, ?[*]u8, c_int) callconv(.C) c_int,
    ...
    checksum: c_ulong,
    checksum_ptr: ?[*]u8,
    update_checksum: ?fn (c_ulong, ?[*:0]const u8, c_uint) callconv(.C) c_ulong,
    read_pause: ?fn (?*anyopaque, c_int) callconv(.C) c_int,
    read_seek: ?fn (?*anyopaque, c_int, i64, c_int) callconv(.C) i64,
    seekable: c_int,
    direct: c_int,
    protocol_whitelist: ?[*:0]const u8,
    protocol_blacklist: ?[*:0]const u8,
    write_data_type: ?fn (?*anyopaque, ?[*]u8, c_int, enum_AVIODataMarkerType, i64) callconv(.C) c_int,
...
pub extern fn avio_find_protocol_name(url: ?[*:0]const u8) ?[*:0]const u8;
pub extern fn avio_check(url: ?[*:0]const u8, flags: c_int) c_int;
pub extern fn avio_open_dir(s: [*c][*c]AVIODirContext, url: ?[*:0]const u8, options: [*c]?*AVDictionary) c_int;
...
pub extern fn avio_alloc_context(buffer: ?[*]u8, buffer_size: c_int, write_flag: c_int, @"opaque": ?*anyopaque, read_packet: ?fn (?*anyopaque, ?[*]u8, c_int) callconv(.C) c_int, write_packet: ?fn (?*anyopaque, ?[*]u8, c_int) callconv(.C) c_int, seek: ?fn (?*anyopaque, i64, c_int) callconv(.C) i64) [*c]AVIOContext;
pub extern fn avio_context_free(s: [*c][*c]AVIOContext) void;
pub extern fn avio_w8(s: [*c]AVIOContext, b: c_int) void;
pub extern fn avio_write(s: [*c]AVIOContext, buf: ?[*:0]const u8, size: c_int) void;
...
pub extern fn avio_put_str(s: [*c]AVIOContext, str: ?[*:0]const u8) c_int;
pub extern fn avio_put_str16le(s: [*c]AVIOContext, str: ?[*:0]const u8) c_int;
pub extern fn avio_put_str16be(s: [*c]AVIOContext, str: ?[*:0]const u8) c_int;
...
pub extern fn avio_printf(s: [*c]AVIOContext, fmt: ?[*:0]const u8, ...) c_int;
pub extern fn avio_print_string_array(s: [*c]AVIOContext, strings: [*c]?[*:0]const u8) void;
pub extern fn avio_flush(s: [*c]AVIOContext) void;
pub extern fn avio_read(s: [*c]AVIOContext, buf: ?[*]u8, size: c_int) c_int;
pub extern fn avio_read_partial(s: [*c]AVIOContext, buf: ?[*]u8, size: c_int) c_int;
...
pub extern fn avio_get_str(pb: [*c]AVIOContext, maxlen: c_int, buf: ?[*]u8, buflen: c_int) c_int;
pub extern fn avio_get_str16le(pb: [*c]AVIOContext, maxlen: c_int, buf: ?[*]u8, buflen: c_int) c_int;
pub extern fn avio_get_str16be(pb: [*c]AVIOContext, maxlen: c_int, buf: ?[*]u8, buflen: c_int) c_int;
pub extern fn avio_open(s: [*c][*c]AVIOContext, url: ?[*:0]const u8, flags: c_int) c_int;
pub extern fn avio_open2(s: [*c][*c]AVIOContext, url: ?[*:0]const u8, flags: c_int, int_cb: [*c]const AVIOInterruptCB, options: [*c]?*AVDictionary) c_int;
...
pub extern fn avio_get_dyn_buf(s: [*c]AVIOContext, pbuffer: [*c]?[*]u8) c_int;
pub extern fn avio_close_dyn_buf(s: [*c]AVIOContext, pbuffer: [*c]?[*]u8) c_int;
pub extern fn avio_enum_protocols(@"opaque": [*c]?*anyopaque, output: c_int) ?[*:0]const u8;
pub extern fn avio_protocol_get_class(name: ?[*:0]const u8) [*c]const AVClass;
...
pub const struct_AVFormatContext = extern struct {
    ...
    io_open: ?fn ([*c]struct_AVFormatContext, [*c][*c]AVIOContext, ?[*:0]const u8, c_int, [*c]?*AVDictionary) callconv(.C) c_int,
...
pub const enum_AVStreamParseType = c_uint; // include/libavformat/avformat.h:819:9: warning: struct demoted to opaque type - has bitfield
pub const struct_AVIndexEntry = opaque {};
pub const AVIndexEntry = struct_AVIndexEntry;
pub extern fn av_disposition_from_string(disp: ?[*:0]const u8) c_int;
pub extern fn av_disposition_to_string(disposition: c_int) ?[*:0]const u8;
...
pub const AVOpenCallback = ?fn ([*c]struct_AVFormatContext, [*c][*c]AVIOContext, ?[*:0]const u8, c_int, [*c]const AVIOInterruptCB, [*c]?*AVDictionary) callconv(.C) c_int;
...
pub extern fn avformat_configuration() ?[*:0]const u8;
pub extern fn avformat_license() ?[*:0]const u8;
...
pub extern fn av_stream_add_side_data(st: [*c]AVStream, @"type": enum_AVPacketSideDataType, data: ?[*]u8, size: usize) c_int;
pub extern fn av_stream_new_side_data(stream: [*c]AVStream, @"type": enum_AVPacketSideDataType, size: usize) ?[*]u8;
pub extern fn av_stream_get_side_data(stream: [*c]const AVStream, @"type": enum_AVPacketSideDataType, size: [*c]usize) ?[*]u8;
pub extern fn av_new_program(s: [*c]AVFormatContext, id: c_int) [*c]AVProgram;
pub extern fn avformat_alloc_output_context2(ctx: [*c][*c]AVFormatContext, oformat: [*c]const AVOutputFormat, format_name: ?[*:0]const u8, filename: ?[*:0]const u8) c_int;
pub extern fn av_find_input_format(short_name: ?[*:0]const u8) [*c]const AVInputFormat;
...
pub extern fn av_probe_input_buffer2(pb: [*c]AVIOContext, fmt: [*c][*c]const AVInputFormat, url: ?[*:0]const u8, logctx: ?*anyopaque, offset: c_uint, max_probe_size: c_uint) c_int;
pub extern fn av_probe_input_buffer(pb: [*c]AVIOContext, fmt: [*c][*c]const AVInputFormat, url: ?[*:0]const u8, logctx: ?*anyopaque, offset: c_uint, max_probe_size: c_uint) c_int;
pub extern fn avformat_open_input(ps: [*c][*c]AVFormatContext, url: ?[*:0]const u8, fmt: [*c]const AVInputFormat, options: [*c]?*AVDictionary) c_int;
...
pub extern fn av_guess_format(short_name: ?[*:0]const u8, filename: ?[*:0]const u8, mime_type: ?[*:0]const u8) [*c]const AVOutputFormat;
pub extern fn av_guess_codec(fmt: [*c]const AVOutputFormat, short_name: ?[*:0]const u8, filename: ?[*:0]const u8, mime_type: ?[*:0]const u8, @"type": enum_AVMediaType) enum_AVCodecID;
pub extern fn av_get_output_timestamp(s: [*c]struct_AVFormatContext, stream: c_int, dts: [*c]i64, wall: [*c]i64) c_int;
pub extern fn av_hex_dump(f: [*c]FILE, buf: ?[*:0]const u8, size: c_int) void;
pub extern fn av_hex_dump_log(avcl: ?*anyopaque, level: c_int, buf: ?[*:0]const u8, size: c_int) void;
...
pub extern fn av_url_split(proto: ?[*]u8, proto_size: c_int, authorization: ?[*]u8, authorization_size: c_int, hostname: ?[*]u8, hostname_size: c_int, port_ptr: [*c]c_int, path: ?[*]u8, path_size: c_int, url: ?[*:0]const u8) void;
pub extern fn av_dump_format(ic: [*c]AVFormatContext, index: c_int, url: ?[*:0]const u8, is_output: c_int) void;
pub extern fn av_get_frame_filename2(buf: ?[*]u8, buf_size: c_int, path: ?[*:0]const u8, number: c_int, flags: c_int) c_int;
pub extern fn av_get_frame_filename(buf: ?[*]u8, buf_size: c_int, path: ?[*:0]const u8, number: c_int) c_int;
pub extern fn av_filename_number_test(filename: ?[*:0]const u8) c_int;
pub extern fn av_sdp_create(ac: [*c][*c]AVFormatContext, n_files: c_int, buf: ?[*]u8, size: c_int) c_int;
pub extern fn av_match_ext(filename: ?[*:0]const u8, extensions: ?[*:0]const u8) c_int;
...
pub extern fn avformat_match_stream_specifier(s: [*c]AVFormatContext, st: [*c]AVStream, spec: ?[*:0]const u8) c_int;
...
pub extern fn swscale_configuration() ?[*:0]const u8;
pub extern fn swscale_license() ?[*:0]const u8;
...
pub extern fn sws_scale(c: ?*struct_SwsContext, srcSlice: [*c]const ?[*:0]const u8, srcStride: [*c]const c_int, srcSliceY: c_int, srcSliceH: c_int, dst: [*c]const ?[*]u8, dstStride: [*c]const c_int) c_int;
...
pub extern fn sws_convertPalette8ToPacked32(src: ?[*:0]const u8, dst: ?[*]u8, num_pixels: c_int, palette: ?[*:0]const u8) void;
pub extern fn sws_convertPalette8ToPacked24(src: ?[*:0]const u8, dst: ?[*]u8, num_pixels: c_int, palette: ?[*:0]const u8) void;
...
pub extern fn swr_convert(s: ?*struct_SwrContext, out: [*c]?[*]u8, out_count: c_int, in: [*c]?[*:0]const u8, in_count: c_int) c_int;
...
pub extern fn swresample_configuration() ?[*:0]const u8;
pub extern fn swresample_license() ?[*:0]const u8;
...
pub const __GLIBC_USE = @compileError("unable to translate macro: undefined identifier `__GLIBC_USE_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/features.h:186:9
pub const __glibc_has_attribute = @compileError("unable to translate macro: undefined identifier `__has_attribute`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:44:10
pub const __glibc_has_extension = @compileError("unable to translate macro: undefined identifier `__has_extension`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:54:10
pub const __THROW = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:78:11
pub const __THROWNL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:79:11
pub const __NTH = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:80:11
pub const __NTHNL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:81:11
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token '##'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:123:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token '#'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:124:9
pub const __warnattr = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:158:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:159:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token '['"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:167:10
pub const __REDIRECT = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:198:10
pub const __REDIRECT_NTH = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:205:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:207:11
pub const __ASMNAME2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:211:10
pub const __attribute_malloc__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:232:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:243:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:250:10
pub const __attribute_const__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:257:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:263:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:272:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:273:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:281:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:291:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:304:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:314:10
pub const __nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:324:11
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:337:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:346:10
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:364:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:373:10
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:391:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:392:11
pub const __restrict_arr = @compileError("unable to translate macro: undefined identifier `__restrict`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:435:10
pub const __attribute_copy__ = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:484:10
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:560:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:561:10
pub const __glibc_macro_warning1 = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:575:10
pub const __glibc_macro_warning = @compileError("unable to translate macro: undefined identifier `GCC`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:576:10
pub const __attr_access = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:612:11
pub const __attr_access_none = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:613:11
pub const __attr_dealloc = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:623:10
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/sys/cdefs.h:630:10
pub const __STD_TYPE = @compileError("unable to translate C expr: unexpected token 'typedef'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/types.h:137:10
pub const __FSID_T_TYPE = @compileError("unable to translate macro: undefined identifier `__val`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
pub const __INT64_C = @compileError("unable to translate macro: undefined identifier `L`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:106:11
pub const __UINT64_C = @compileError("unable to translate macro: undefined identifier `UL`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:107:11
pub const INT64_C = @compileError("unable to translate macro: undefined identifier `L`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:252:11
pub const UINT32_C = @compileError("unable to translate macro: undefined identifier `U`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:260:10
pub const UINT64_C = @compileError("unable to translate macro: undefined identifier `UL`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:262:11
pub const INTMAX_C = @compileError("unable to translate macro: undefined identifier `L`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:269:11
pub const UINTMAX_C = @compileError("unable to translate macro: undefined identifier `UL`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/stdint.h:270:11
pub const av_always_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:45:13
pub const av_extern_inline = @compileError("unable to translate C expr: unexpected token 'extern'"); // include/libavutil/attributes.h:55:13
pub const av_warn_unused_result = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:62:13
pub const av_noinline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:68:13
pub const av_pure = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:76:13
pub const av_const = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:82:13
pub const av_cold = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:88:13
pub const attribute_deprecated = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:100:13
pub const AV_NOWARN_DEPRECATED = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // include/libavutil/attributes.h:114:13
pub const av_unused = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:131:13
pub const av_used = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:142:13
pub const av_alias = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:148:12
pub const av_uninit = @compileError("unable to translate C expr: unexpected token '='"); // include/libavutil/attributes.h:154:13
pub const av_printf_format = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:161:13
pub const av_noreturn = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/attributes.h:168:13
pub const __f32 = @compileError("unable to translate macro: undefined identifier `f`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:91:12
pub const __f64x = @compileError("unable to translate macro: undefined identifier `l`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:120:13
pub const __CFLOAT32 = @compileError("unable to translate: TODO _Complex"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
pub const __builtin_nansf32 = @compileError("unable to translate macro: undefined identifier `__builtin_nansf`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate macro: undefined identifier `__builtin_inf`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nan`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate macro: undefined identifier `__builtin_inf`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nan`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nans`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate macro: undefined identifier `__builtin_infl`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nanl`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/floatn-common.h:292:13
pub const HUGE_VAL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:48:10
pub const HUGE_VALL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:60:11
pub const __SIMD_DECL = @compileError("unable to translate macro: undefined identifier `__DECL_SIMD_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:276:9
pub const __MATHCALL_VEC = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:278:9
pub const __MATHDECL_VEC = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:282:9
pub const __MATHDECL = @compileError("unable to translate macro: undefined identifier `__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:288:9
pub const __MATHDECLX = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:293:9
pub const __MATHDECL_1_IMPL = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:296:9
pub const __MATHREDIR = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:305:9
pub const __MATHCALL_NARROW_ARGS_1 = @compileError("unable to translate macro: undefined identifier `_Marg_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:550:9
pub const __MATHCALL_NARROW_ARGS_2 = @compileError("unable to translate macro: undefined identifier `_Marg_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:551:9
pub const __MATHCALL_NARROW_ARGS_3 = @compileError("unable to translate macro: undefined identifier `_Marg_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:552:9
pub const __MATHCALL_NARROW_NORMAL = @compileError("unable to translate macro: undefined identifier `_Mret_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:553:9
pub const __MATHCALL_NARROW_REDIR = @compileError("unable to translate macro: undefined identifier `_Mret_`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:555:9
pub const __MATH_TG = @compileError("unable to translate macro: undefined identifier `f`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:916:10
pub const fpclassify = @compileError("unable to translate macro: undefined identifier `__builtin_fpclassify`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:961:11
pub const isfinite = @compileError("unable to translate macro: undefined identifier `__builtin_isfinite`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:988:11
pub const isnormal = @compileError("unable to translate macro: undefined identifier `__builtin_isnormal`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:996:11
pub const isgreater = @compileError("unable to translate macro: undefined identifier `__builtin_isgreater`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:1282:11
pub const isgreaterequal = @compileError("unable to translate macro: undefined identifier `__builtin_isgreaterequal`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:1283:11
pub const isless = @compileError("unable to translate macro: undefined identifier `__builtin_isless`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:1284:11
pub const islessequal = @compileError("unable to translate macro: undefined identifier `__builtin_islessequal`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:1285:11
pub const islessgreater = @compileError("unable to translate macro: undefined identifier `__builtin_islessgreater`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:1286:11
pub const isunordered = @compileError("unable to translate macro: undefined identifier `__builtin_isunordered`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/math.h:1287:11
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/include/stdarg.h:27:9
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
pub const __FD_ZERO = @compileError("unable to translate macro: undefined identifier `__i`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got '|='"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got '&='"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/select.h:34:9
pub const __PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token '{'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/libc/include/generic-glibc/bits/thread-shared-types.h:127:9
pub const FFSWAP = @compileError("unable to translate macro: undefined identifier `SWAP_tmp`"); // include/libavutil/macros.h:52:9
pub const FF_ARRAY_ELEMS = @compileError("unable to translate C expr: unexpected token '('"); // include/libavutil/macros.h:53:9
pub const AV_TOSTRING = @compileError("unable to translate C expr: unexpected token '#'"); // include/libavutil/macros.h:67:9
pub const AV_GLUE = @compileError("unable to translate C expr: unexpected token '##'"); // include/libavutil/macros.h:69:9
pub const AV_PRAGMA = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // include/libavutil/macros.h:76:9
pub const GET_UTF8 = @compileError("unable to translate macro: undefined identifier `top`"); // include/libavutil/common.h:469:9
pub const GET_UTF16 = @compileError("unable to translate macro: undefined identifier `hi`"); // include/libavutil/common.h:494:9
pub const PUT_UTF8 = @compileError("unable to translate macro: undefined identifier `bytes`"); // include/libavutil/common.h:522:9
pub const PUT_UTF16 = @compileError("unable to translate macro: undefined identifier `in`"); // include/libavutil/common.h:556:9
pub const AV_VERSION_DOT = @compileError("unable to translate C expr: unexpected token '##'"); // include/libavutil/version.h:57:9
pub const DECLARE_ALIGNED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/mem.h:116:13
pub const DECLARE_ASM_ALIGNED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/mem.h:117:13
pub const DECLARE_ASM_CONST = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/mem.h:118:13
pub const av_malloc_attrib = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // include/libavutil/mem.h:151:13
pub const av_alloc_size = @compileError("unable to translate C expr: expected ')' instead got '...'"); // include/libavutil/mem.h:174:13
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/adebayo/bin/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab/lib/include/stddef.h:104:9
pub const av_err2str = @compileError("unable to translate C expr: expected ')' instead got '['"); // include/libavutil/error.h:121:9
pub const AV_PIX_FMT_NE = @compileError("unable to translate macro: undefined identifier `AV_PIX_FMT_`"); // include/libavutil/pixfmt.h:376:12
pub const AV_PIX_FMT_RGB32 = @compileError("unable to translate macro: undefined identifier `ARGB`"); // include/libavutil/pixfmt.h:379:9
pub const AV_PIX_FMT_RGB32_1 = @compileError("unable to translate macro: undefined identifier `RGBA`"); // include/libavutil/pixfmt.h:380:9
pub const AV_PIX_FMT_BGR32 = @compileError("unable to translate macro: undefined identifier `ABGR`"); // include/libavutil/pixfmt.h:381:9
pub const AV_PIX_FMT_BGR32_1 = @compileError("unable to translate macro: undefined identifier `BGRA`"); // include/libavutil/pixfmt.h:382:9
pub const AV_PIX_FMT_0RGB32 = @compileError("unable to translate macro: undefined identifier `RGB`"); // include/libavutil/pixfmt.h:383:9
pub const AV_PIX_FMT_0BGR32 = @compileError("unable to translate macro: undefined identifier `GR`"); // include/libavutil/pixfmt.h:384:9
pub const AV_PIX_FMT_GRAY9 = @compileError("unable to translate macro: undefined identifier `GRAY9BE`"); // include/libavutil/pixfmt.h:386:9
pub const AV_PIX_FMT_GRAY10 = @compileError("unable to translate macro: undefined identifier `GRAY10BE`"); // include/libavutil/pixfmt.h:387:9
pub const AV_PIX_FMT_GRAY12 = @compileError("unable to translate macro: undefined identifier `GRAY12BE`"); // include/libavutil/pixfmt.h:388:9
pub const AV_PIX_FMT_GRAY14 = @compileError("unable to translate macro: undefined identifier `GRAY14BE`"); // include/libavutil/pixfmt.h:389:9
pub const AV_PIX_FMT_GRAY16 = @compileError("unable to translate macro: undefined identifier `GRAY16BE`"); // include/libavutil/pixfmt.h:390:9
pub const AV_PIX_FMT_YA16 = @compileError("unable to translate macro: undefined identifier `YA16BE`"); // include/libavutil/pixfmt.h:391:9
pub const AV_PIX_FMT_RGB48 = @compileError("unable to translate macro: undefined identifier `RGB48BE`"); // include/libavutil/pixfmt.h:392:9
pub const AV_PIX_FMT_RGB565 = @compileError("unable to translate macro: undefined identifier `RGB565BE`"); // include/libavutil/pixfmt.h:393:9
pub const AV_PIX_FMT_RGB555 = @compileError("unable to translate macro: undefined identifier `RGB555BE`"); // include/libavutil/pixfmt.h:394:9
pub const AV_PIX_FMT_RGB444 = @compileError("unable to translate macro: undefined identifier `RGB444BE`"); // include/libavutil/pixfmt.h:395:9
pub const AV_PIX_FMT_RGBA64 = @compileError("unable to translate macro: undefined identifier `RGBA64BE`"); // include/libavutil/pixfmt.h:396:9
pub const AV_PIX_FMT_BGR48 = @compileError("unable to translate macro: undefined identifier `BGR48BE`"); // include/libavutil/pixfmt.h:397:9
pub const AV_PIX_FMT_BGR565 = @compileError("unable to translate macro: undefined identifier `BGR565BE`"); // include/libavutil/pixfmt.h:398:9
pub const AV_PIX_FMT_BGR555 = @compileError("unable to translate macro: undefined identifier `BGR555BE`"); // include/libavutil/pixfmt.h:399:9
pub const AV_PIX_FMT_BGR444 = @compileError("unable to translate macro: undefined identifier `BGR444BE`"); // include/libavutil/pixfmt.h:400:9
pub const AV_PIX_FMT_BGRA64 = @compileError("unable to translate macro: undefined identifier `BGRA64BE`"); // include/libavutil/pixfmt.h:401:9
pub const AV_PIX_FMT_YUV420P9 = @compileError("unable to translate macro: undefined identifier `YUV420P9BE`"); // include/libavutil/pixfmt.h:403:9
pub const AV_PIX_FMT_YUV422P9 = @compileError("unable to translate macro: undefined identifier `YUV422P9BE`"); // include/libavutil/pixfmt.h:404:9
pub const AV_PIX_FMT_YUV444P9 = @compileError("unable to translate macro: undefined identifier `YUV444P9BE`"); // include/libavutil/pixfmt.h:405:9
pub const AV_PIX_FMT_YUV420P10 = @compileError("unable to translate macro: undefined identifier `YUV420P10BE`"); // include/libavutil/pixfmt.h:406:9
pub const AV_PIX_FMT_YUV422P10 = @compileError("unable to translate macro: undefined identifier `YUV422P10BE`"); // include/libavutil/pixfmt.h:407:9
pub const AV_PIX_FMT_YUV440P10 = @compileError("unable to translate macro: undefined identifier `YUV440P10BE`"); // include/libavutil/pixfmt.h:408:9
pub const AV_PIX_FMT_YUV444P10 = @compileError("unable to translate macro: undefined identifier `YUV444P10BE`"); // include/libavutil/pixfmt.h:409:9
pub const AV_PIX_FMT_YUV420P12 = @compileError("unable to translate macro: undefined identifier `YUV420P12BE`"); // include/libavutil/pixfmt.h:410:9
pub const AV_PIX_FMT_YUV422P12 = @compileError("unable to translate macro: undefined identifier `YUV422P12BE`"); // include/libavutil/pixfmt.h:411:9
pub const AV_PIX_FMT_YUV440P12 = @compileError("unable to translate macro: undefined identifier `YUV440P12BE`"); // include/libavutil/pixfmt.h:412:9
pub const AV_PIX_FMT_YUV444P12 = @compileError("unable to translate macro: undefined identifier `YUV444P12BE`"); // include/libavutil/pixfmt.h:413:9
pub const AV_PIX_FMT_YUV420P14 = @compileError("unable to translate macro: undefined identifier `YUV420P14BE`"); // include/libavutil/pixfmt.h:414:9
pub const AV_PIX_FMT_YUV422P14 = @compileError("unable to translate macro: undefined identifier `YUV422P14BE`"); // include/libavutil/pixfmt.h:415:9
pub const AV_PIX_FMT_YUV444P14 = @compileError("unable to translate macro: undefined identifier `YUV444P14BE`"); // include/libavutil/pixfmt.h:416:9
pub const AV_PIX_FMT_YUV420P16 = @compileError("unable to translate macro: undefined identifier `YUV420P16BE`"); // include/libavutil/pixfmt.h:417:9
pub const AV_PIX_FMT_YUV422P16 = @compileError("unable to translate macro: undefined identifier `YUV422P16BE`"); // include/libavutil/pixfmt.h:418:9
pub const AV_PIX_FMT_YUV444P16 = @compileError("unable to translate macro: undefined identifier `YUV444P16BE`"); // include/libavutil/pixfmt.h:419:9
pub const AV_PIX_FMT_GBRP9 = @compileError("unable to translate macro: undefined identifier `GBRP9BE`"); // include/libavutil/pixfmt.h:421:9
pub const AV_PIX_FMT_GBRP10 = @compileError("unable to translate macro: undefined identifier `GBRP10BE`"); // include/libavutil/pixfmt.h:422:9
pub const AV_PIX_FMT_GBRP12 = @compileError("unable to translate macro: undefined identifier `GBRP12BE`"); // include/libavutil/pixfmt.h:423:9
pub const AV_PIX_FMT_GBRP14 = @compileError("unable to translate macro: undefined identifier `GBRP14BE`"); // include/libavutil/pixfmt.h:424:9
pub const AV_PIX_FMT_GBRP16 = @compileError("unable to translate macro: undefined identifier `GBRP16BE`"); // include/libavutil/pixfmt.h:425:9
pub const AV_PIX_FMT_GBRAP10 = @compileError("unable to translate macro: undefined identifier `GBRAP10BE`"); // include/libavutil/pixfmt.h:426:9
pub const AV_PIX_FMT_GBRAP12 = @compileError("unable to translate macro: undefined identifier `GBRAP12BE`"); // include/libavutil/pixfmt.h:427:9
pub const AV_PIX_FMT_GBRAP16 = @compileError("unable to translate macro: undefined identifier `GBRAP16BE`"); // include/libavutil/pixfmt.h:428:9
pub const AV_PIX_FMT_BAYER_BGGR16 = @compileError("unable to translate macro: undefined identifier `BAYER_BGGR16BE`"); // include/libavutil/pixfmt.h:430:9
pub const AV_PIX_FMT_BAYER_RGGB16 = @compileError("unable to translate macro: undefined identifier `BAYER_RGGB16BE`"); // include/libavutil/pixfmt.h:431:9
pub const AV_PIX_FMT_BAYER_GBRG16 = @compileError("unable to translate macro: undefined identifier `BAYER_GBRG16BE`"); // include/libavutil/pixfmt.h:432:9
pub const AV_PIX_FMT_BAYER_GRBG16 = @compileError("unable to translate macro: undefined identifier `BAYER_GRBG16BE`"); // include/libavutil/pixfmt.h:433:9
pub const AV_PIX_FMT_GBRPF32 = @compileError("unable to translate macro: undefined identifier `GBRPF32BE`"); // include/libavutil/pixfmt.h:435:9
pub const AV_PIX_FMT_GBRAPF32 = @compileError("unable to translate macro: undefined identifier `GBRAPF32BE`"); // include/libavutil/pixfmt.h:436:9
pub const AV_PIX_FMT_GRAYF32 = @compileError("unable to translate macro: undefined identifier `GRAYF32BE`"); // include/libavutil/pixfmt.h:438:9
pub const AV_PIX_FMT_YUVA420P9 = @compileError("unable to translate macro: undefined identifier `YUVA420P9BE`"); // include/libavutil/pixfmt.h:440:9
pub const AV_PIX_FMT_YUVA422P9 = @compileError("unable to translate macro: undefined identifier `YUVA422P9BE`"); // include/libavutil/pixfmt.h:441:9
pub const AV_PIX_FMT_YUVA444P9 = @compileError("unable to translate macro: undefined identifier `YUVA444P9BE`"); // include/libavutil/pixfmt.h:442:9
pub const AV_PIX_FMT_YUVA420P10 = @compileError("unable to translate macro: undefined identifier `YUVA420P10BE`"); // include/libavutil/pixfmt.h:443:9
pub const AV_PIX_FMT_YUVA422P10 = @compileError("unable to translate macro: undefined identifier `YUVA422P10BE`"); // include/libavutil/pixfmt.h:444:9
pub const AV_PIX_FMT_YUVA444P10 = @compileError("unable to translate macro: undefined identifier `YUVA444P10BE`"); // include/libavutil/pixfmt.h:445:9
pub const AV_PIX_FMT_YUVA422P12 = @compileError("unable to translate macro: undefined identifier `YUVA422P12BE`"); // include/libavutil/pixfmt.h:446:9
pub const AV_PIX_FMT_YUVA444P12 = @compileError("unable to translate macro: undefined identifier `YUVA444P12BE`"); // include/libavutil/pixfmt.h:447:9
pub const AV_PIX_FMT_YUVA420P16 = @compileError("unable to translate macro: undefined identifier `YUVA420P16BE`"); // include/libavutil/pixfmt.h:448:9
pub const AV_PIX_FMT_YUVA422P16 = @compileError("unable to translate macro: undefined identifier `YUVA422P16BE`"); // include/libavutil/pixfmt.h:449:9
pub const AV_PIX_FMT_YUVA444P16 = @compileError("unable to translate macro: undefined identifier `YUVA444P16BE`"); // include/libavutil/pixfmt.h:450:9
pub const AV_PIX_FMT_XYZ12 = @compileError("unable to translate macro: undefined identifier `XYZ12BE`"); // include/libavutil/pixfmt.h:452:9
pub const AV_PIX_FMT_NV20 = @compileError("unable to translate macro: undefined identifier `NV20BE`"); // include/libavutil/pixfmt.h:453:9
pub const AV_PIX_FMT_AYUV64 = @compileError("unable to translate macro: undefined identifier `AYUV64BE`"); // include/libavutil/pixfmt.h:454:9
pub const AV_PIX_FMT_P010 = @compileError("unable to translate macro: undefined identifier `P010BE`"); // include/libavutil/pixfmt.h:455:9
pub const AV_PIX_FMT_P016 = @compileError("unable to translate macro: undefined identifier `P016BE`"); // include/libavutil/pixfmt.h:456:9
pub const AV_PIX_FMT_Y210 = @compileError("unable to translate macro: undefined identifier `Y210BE`"); // include/libavutil/pixfmt.h:458:9
pub const AV_PIX_FMT_X2RGB10 = @compileError("unable to translate macro: undefined identifier `X2RGB10BE`"); // include/libavutil/pixfmt.h:459:9
pub const AV_PIX_FMT_X2BGR10 = @compileError("unable to translate macro: undefined identifier `X2BGR10BE`"); // include/libavutil/pixfmt.h:460:9
pub const AV_PIX_FMT_P210 = @compileError("unable to translate macro: undefined identifier `P210BE`"); // include/libavutil/pixfmt.h:462:9
pub const AV_PIX_FMT_P410 = @compileError("unable to translate macro: undefined identifier `P410BE`"); // include/libavutil/pixfmt.h:463:9
pub const AV_PIX_FMT_P216 = @compileError("unable to translate macro: undefined identifier `P216BE`"); // include/libavutil/pixfmt.h:464:9
pub const AV_PIX_FMT_P416 = @compileError("unable to translate macro: undefined identifier `P416BE`"); // include/libavutil/pixfmt.h:465:9
pub const av_int_list_length = @compileError("unable to translate C expr: unexpected token '*'"); // include/libavutil/avutil.h:331:9
pub const av_fourcc2str = @compileError("unable to translate C expr: expected ')' instead got '['"); // include/libavutil/avutil.h:354:9
pub const AV_CHANNEL_LAYOUT_MASK = @compileError("unable to translate C expr: unexpected token '{'"); // include/libavutil/channel_layout.h:350:9
pub const AV_CHANNEL_LAYOUT_AMBISONIC_FIRST_ORDER = @compileError("unable to translate C expr: unexpected token '{'"); // include/libavutil/channel_layout.h:382:9
pub const avio_print = @compileError("unable to translate C expr: expected ')' instead got '...'"); // include/libavformat/avio.h:542:9
